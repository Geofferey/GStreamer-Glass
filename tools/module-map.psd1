@{
    ...
    '13-ProcessLifecycle.ps1' = @(
        ...
        'Scroll-TextBoxToBottom'
        'Scroll-LogToBottom'
        'Test-LogPopoutViewLive'
    ...
    '16-CaptureAndAudioDevices.ps1' = @(
        ...
        'Get-EffectiveQueueLeakValue'
        'Get-EffectiveVideoInputQueueLeakValue'
        'Get-EffectiveVideoOutputQueueLeakValue'
        'Get-EffectiveAudioInputQueueLeakValue'
        'Get-EffectiveAudioOutputQueueLeakValue'
        'Get-AudioTimingMode'
    ...
    '17-DirectWebRtcPipeline.ps1' = @(
        ...
        'Get-DirectWebRtcSignalingServerBindHost'
        'Get-DirectWebRtcWebServerBindAddress'
    ...
    '33-LetsEncrypt.ps1' = @(
        ...
        'ConvertFrom-PemBody'
        'Read-DerTlv'
        'ConvertFrom-DerInteger'
        'ConvertFrom-Pkcs1RsaPrivateKeyDer'
        'ConvertFrom-Pkcs8PrivateKeyInfoDer'
        'Import-TlsPrivateKeyFile'
        ...
        'Resolve-EmbeddedTlsCertificatePath'
        'Test-EmbeddedTlsActive'
        'Test-EmbeddedTlsInsecurePortsRestricted'
        'Get-EmbeddedTlsCertificate'
        'Update-LetsEncryptCertificate'
        'Remove-LetsEncryptCertificate'
        ...
        'Remove-ViewerAuthenticationAccount'
        ...
        'Stop-AuthProxyWorkerIfViewerAuthenticationDisabled'
