...
Assert-SignalingHeartbeat ($player.Contains("FRONTEND_VERSION = '3.8-viewer-auth-52'")) 'The frontend version was not advanced for the current viewer release.'
Assert-SignalingHeartbeat ($serviceWorker.Contains("gstglass-pwa-3.8-viewer-auth-63")) 'The PWA cache was not advanced for the current viewer release.'
Assert-SignalingHeartbeat ($webUiManifest.webUiVersion -eq '3.8.62') 'The packaged Web UI version was not advanced for the current viewer release.'
