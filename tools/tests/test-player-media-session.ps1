...
Assert-MediaSession ($player.Contains("FRONTEND_VERSION = '3.8-viewer-auth-50'")) 'The frontend version was not advanced for the current viewer release.'
Assert-MediaSession ($serviceWorker.Contains("gstglass-pwa-3.8-viewer-auth-61")) 'The PWA cache was not advanced for the current viewer release.'
Assert-MediaSession ($webUiManifest.webUiVersion -eq '3.8.59') 'The packaged Web UI version was not advanced for the current viewer release.'
